class RegistersController < ApplicationController
  ...
  private
    ...
    def register_params
      params.require(:register).permit(:fname, :lname, :email, :contactno, :collegename, :coladdress, :city, :state, :pincode, :fphydirname, :lphydirname, :pdcontact, :sports, :menwomen, :singdouble, :accepted)
    end
end
